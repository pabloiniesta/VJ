	...
	for(int j=0; j<mapSize.y; j++)
	{
		for(int i=0; i<mapSize.x; i++)
		{
			...
			if(tile == ' ')
				...
				brickInfo.push_back(make_pair('r', make_pair(i, j)));
				map[j * mapSize.x + i] = 0;
			}
			else if (tile == 'g') {
				brickInfo.push_back(make_pair('g', make_pair(i, j)));
				map[j * mapSize.x + i] = 0;
			}
			else if (tile == 'b') {
				brickInfo.push_back(make_pair('b', make_pair(i, j)));
				map[j * mapSize.x + i] = 0;
			}
			else if (tile == 'k') {
				brickInfo.push_back(make_pair('k', make_pair(i, j)));
				map[j * mapSize.x + i] = 0;
			}
			else if (tile == 'A') {
				brickInfo.push_back(make_pair('A', make_pair(i, j)));
				map[j * mapSize.x + i] = 0;
			}
			else if (tile == 'B') {
				brickInfo.push_back(make_pair('B', make_pair(i, j)));
				...
				brickInfo.push_back(make_pair('t', make_pair(i, j)));
				map[j * mapSize.x + i] = 0;
			}
			else if (tile == '?') {
				brickInfo.push_back(make_pair('?', make_pair(i, j)));
				map[j * mapSize.x + i] = 0;
			}
			else
